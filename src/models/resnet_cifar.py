...
def resnet20(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_s:
    return _resnet("resnet20", BasicBlock, [3, 3, 3], pretrained, progress, **kwargs)

def resnet32(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_s:
    return _resnet("resnet32", BasicBlock, [5, 5, 5], pretrained, progress, **kwargs)

def resnet44(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_s:
    return _resnet("resnet44", BasicBlock, [7, 7, 7], pretrained, progress, **kwargs)

def resnet56(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_s:
...
def _resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNet_s(block, layers, **kwargs)
    if pretrained:
