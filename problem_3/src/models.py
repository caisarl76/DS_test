...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10, use_norm=False, return_vec=True):
...
def resnet44(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    return _resnet("resnet44", BasicBlock, [7, 7, 7], pretrained, progress, **kwargs)

def resnet56(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
